<div ng-controller="ReportTemplateCtrl" ng-hide="isShowTables" class="transition">
	...
	<div class="templatelist-wrap" id="templateList" ng-show="template_list">
		<table class="template-list table table-hover table-bordered">
			<tr class="" ng-repeat="item in template_list">
				<td ng-click="applyTemplate($index)" ng-class="{active: isSelected($index)}" class="link">
					...
					<span class="info-panel label label-default"><span class="glyphicon glyphicon-search"></span> {{item.report_format.label}}</span>
