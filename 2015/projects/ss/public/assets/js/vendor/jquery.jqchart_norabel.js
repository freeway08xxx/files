		...
		jQuery.extend( $.fn.jQchart,{
			...
			init :	function (op){ 
				...
				this.op=jQuery.extend({
					...
					labelDataShow	: op.config.labelDataShow || false,
				...
				this.op.grid	= {
						col:(this.op.labelX)?
							...
							this.op.data[0].length+this.op.xGapPaddingR||50,
				...
				if (this.canvas.getContext){
					...
					function draggingon(oj){
						...
						$(oj).draggable({opacity:0.5 })
								...
								*/
								.append('<div id="jQchart-drgmsg-M-'+oj.id+'" class="jQchart-drgmsg-M">draggable-ドラチEげできまぁE/div>')
