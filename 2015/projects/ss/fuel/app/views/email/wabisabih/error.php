...
<br>
<br>
クライアント名：<? if (isset($client_name)) { echo $client_name; } else { echo "--"; } ?>
<br>
入札ルールID  ：<? if (isset($wabisabi_id)) { echo $wabisabi_id; } else { echo "--"; } ?>
<br>
入札ルール名称：<? if (isset($wabisabi_name)) { echo $wabisabi_name; } else { echo "--"; } ?>
<br>
処理回避の理由：<?= $message; ?>
<br>
<br>
