<?php
class Model_Data_Share_CostRate extends \Model
{
	protected static $_table_name = 't_monitor_cost_rate';

  public static function get_cost_rate($industry_class_id, $client_class_id, $device_id){
